# Getting Started with Pascal Triangle kata in Go
...
> ***Reminder***: the commands below should be run from [Kata-PascalTriangle/go](.) directory
...
> ***Reminder***: the command below should be run from [Kata-PascalTriangle/go](.) directory
...
`File` > `Open` > `Kata-PascalTriangle` > `go`
...
Open Visual Studio Code, choose `Open Folder`, navigate to `Kata-PascalTriangle` / `go`
